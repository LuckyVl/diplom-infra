...
Время заверщения make deploy-all 18.09.2026 20:49  
УРА!!! ВСЕ ГОТОВО!!!  
_________
...
_________
Проверяем доступность UI Grafana через Windows (доступ через публичный адрес)  
_________
![alt text](./Img/image-74.png)  
![alt text](./Img/image-75.png)  
_________
Проверяем доступность UI тестового приложения через Windows (доступ через публичный адрес)  
_________
![alt text](./Img/image-76.png)  
_________
Вносим изменение в тестовое приложение (v.2.0.0) , сохраняем изменение в git, ставим tag  
_________
![alt text](./Img/image-78.png)  
_________
Смотрим как запускается сборка, загрузка и деплой новой версии (v.2.0.0) тестового приложения через CI\CD Github  
_________
...
_________
Проверяем через Windows (доступ через публичный адрес) что версия v.2.0.0 тестового приложения доступна  
_________
![alt text](./Img/image-83.png)  
_________
Вносим изменение в тестовое приложение (v.3.0.0.), сохраняем изменение в git, ставим tag  
_________
![alt text](./Img/image-84.png)  
_________
Смотрим как запускается сборка, загрузка и деплой новой версии (v.3.0.0) тестового приложения через CI\CD Github  
_________
...
_________
Проверяем через Windows (доступ через публичный адрес) что версия (v.3.0.0) тестового приложения доступна  
_________
![alt text](./Img/image-92.png)  
_________
Запускаем make destroy-all (разбираем динамическую инфраструктуру)  
_________
![alt text](./Img/image-93.png)  
![alt text](./Img/image-94.png)  
_________
Инфраструктура разобрана, образа удалены из Registry, конфирурации очищены на Ubuntu VM (diplom-vm)  
_________
![alt text](./Img/image-95.png)  
_________
Состояние в облаке Яндекс после уничтожения инфраструктуры  
_________
![alt text](./Img/image-96.png)  
_________
История изменений состояний Terraform в облаке
_________
